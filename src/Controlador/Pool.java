...
public class Pool {
    ...
    public static Connection IniciaPool() throws SQLException {
        try {
            ...
            //comprobaciÃ³n de conexion
             basicdatasource.setValidationQuery("Select 1");
            basicdatasource.setMaxTotal(1);//conexiones del pool
            //basicdatasource.setInitialSize(5); //Cuando el pool comienza el nÃºmero mÃ­nimo de conexiones
            basicdatasource.setMinIdle(50); //Numero minimo de conexiones inactivas que queremos que haya
            basicdatasource.setMaxIdle(100); //Numero mÃ¡ximo de conexciones inactivas que queremos que haya
            basicdatasource.setMaxWaitMillis(1000); //Tiempo que espera en las conexiones.
         
            //Si queremos comprobar que funciona bastarÃ­a con hacer un getConexion
